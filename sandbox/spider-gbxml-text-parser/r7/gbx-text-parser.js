...
GBX.getReports = function() {
	...
	`
		...
		<p>
			...
			<button id=butExposed onclick=GBX.setSurfacesFiltered('exposedToSun="true"',this); >exposed to sun</button>
		</p>
...
GBX.toggleExteriorSurfaces = function( button ) {
